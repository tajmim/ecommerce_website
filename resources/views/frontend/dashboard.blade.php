                    ...
                    <div class="sidemnenu">
                        <ul class="aiz-side-nav-list mb-3 pb-3 border-bottom metismenu" data-toggle="aiz-side-menu">
                            ...
                            <li class="aiz-side-nav-item mm-active">
                                <a href="/dashboard" class="aiz-side-nav-link active" aria-expanded="true">
            ...
            <div class="aiz-user-panel">
                ...
                <div class="row gutters-16">
                    ...
                    <div class="col-xl-8 col-md-6 mb-4">
                        <div class="h-100" style="background-image: url('/frontend/uploads/all/wallet-bg.png'); background-size: cover; background-position: center center;">
                            ...
                            <div class="row h-100  row-cols-1">
                                ...
                                <div class="col">
                                    <div class="p-4 bg-primary " style="margin-bottom: 2rem;">
                                        ...
                                        <a href="/purchase_history" class="fs-12 text-white">
                                            View Order History
                                ...
                                <div class="col">
                                    <div class="p-4 bg-secondary-base">
                                        ...
                                        <a href="/earning-points" class="fs-12 text-white">
                                            Convert Club Points
                                            <i class="las la-angle-right fs-14"></i>
                                        </a>
                                    </div>
                ...
                <div class="row gutters-16 mt-2">
                    ...
                    <div class="col-xl-4 col-md-6 mb-4">
                        <div class="p-4 border h-100">
                            ...
                            <img src="/frontend/uploads/all/zu3eVLzwf8iAs4AG7K5h4902UhaXVR0MbWVevxjJ.webp" class="img-fluid mb-4 h-70px" onerror="this.onerror=null;this.src='/frontend/assets/img/avatar-place.png';">
                            ...
                            <a href="/customer-packages" class="btn btn-primary btn-block fs-14 fw-500" style="border-radius: 25px;">Upgrade Package</a>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-md-6 mb-4">
                        <div class="p-4 border h-100">
                            ...
                            <ul class="list-unstyled mb-5">
                                <li class="fs-14 fw-400 text-derk pb-1"><span>3947 West Side Avenue
                                        Hackensack, NJ 07601,</span></li>
                ...
                <div class="row align-items-center mb-2 mt-1">
                    ...
                    <div class="col-6 text-right">
                        <a class="text-blue fs-10 fs-md-12 fw-700 hov-text-primary animate-underline-primary" href="/wishlists">View All</a>
                    </div>
                </div>
                <div class="row row-cols-xxl-5 row-cols-xl-4 row-cols-lg-4 row-cols-md-3 row-cols-sm-2 row-cols-2 gutters-16 border-top border-left mx-1 mx-md-0 mb-4">
                    ...
                    <div class="aiz-card-box col py-3 text-center border-right border-bottom has-transition hov-shadow-out z-1" id="wishlist_2">
                        <div class="position-relative h-140px h-md-200px img-fit overflow-hidden mb-3">
                            ...
                            <!-- Remove from wishlisht -->
                            <div class="absolute-top-right aiz-p-hov-icon">
                                <a href="javascript:void(0)" onclick="removeFromWishlist(2)" data-toggle="tooltip" data-title="Remove from wishlist" data-placement="left" data-original-title="" title="">
                                    <i class="la la-trash"></i>
                                </a>
                            </div>
                            <!-- add to cart -->
